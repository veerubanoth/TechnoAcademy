      ...
      <div>
         <footer className="text-center rgb(9, 4, 29) text-white px-10 font-Poppins font-light  ">
               ...
               <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="">
                     <h6 className="uppercase font-semibold mb-4 flex items-center justify-center md:justify-start">
                        <div className='flex h-9 mx-1'>
                           <img src={Lambda_logo} alt="logo" />
                        </div>
                  ...
                  <div className="text-gray-600">
                     ...
                     <p className="mb-4">
                        <a href="#!" className="">Video Courses</a>
                     </p>
                     <p className="mb-4">
            ...
            <div className="text-center p-2">
               ...
               <a className="text-gray-600  font-semibold" href="https://technoacademy.net/"> Techno Academy</a>
            </div>
         </footer>
      </div>
   )
